...
from objects_classifier.helping_classes.dataset import Dataset
...
def test(test_filenames):
    ...
    predicted_index = [x > 0.5 for x in predicted_indexes]
    ...
    # TP, FP, TN, FN = 0, 0, 0, 0
    # for gt, pred in zip(ground_truth_is_dog, predicted_label):
    ...
    #         print('predicted is dog = ' + str(predicted_label[idx_image]))
    ...
    #         text += '\nPred '
    #         if predicted_label[idx_image]:
    #             text += 'is dog'
    #         else:
    #             text += 'is not dog'

    #         if ground_truth_is_dog[idx_image] == predicted_label[idx_image]:
    #             color = 'green'
    #         else:
    #             color = 'red'
